...
nome_arquivo_saida='Grade_AG_Bouguer_Poly8.tif';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Dados das estações
Latitudes=Dados(:,1); Longitudes=Dados(:,2); AG_Bouguer=Dados(:,3); % mGal
...
Lat=Latitudes; Long=Longitudes; AG_res=AG_Bouguer; N=Desvios_g;
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==5
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==7
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==8
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==9
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==10
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8+a9*s.^9);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8+a9*si.^9);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==11
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8+a9*s.^9+a10*s.^10);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8+a9*si.^9+a10*si.^10);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==12
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8+a9*s.^9+a10*s.^10+a11*s.^11);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8+a9*si.^9+a10*si.^10+a11*si.^11);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==13
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8+a9*s.^9+a10*s.^10+a11*s.^11+a12*s.^12);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8+a9*si.^9+a10*si.^10+a11*si.^11+a12*si.^12);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==14
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8+a9*s.^9+a10*s.^10+a11*s.^11+a12*s.^12+a13*s.^13);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8+a9*si.^9+a10*si.^10+a11*si.^11+a12*si.^12+a13*si.^13);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==15
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8+a9*s.^9+a10*s.^10+a11*s.^11+a12*s.^12+a13*s.^13+a14*s.^14);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8+a9*si.^9+a10*si.^10+a11*si.^11+a12*si.^12+a13*si.^13+a14*si.^14);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
elseif n==16
...
s2=(X*ones(size(X))'-ones(size(X))*X').^2+(Y*ones(size(Y))'-ones(size(Y))*Y').^2;
s=sqrt(s2);
Czz=(a0+a1*s+a2*s.^2+a3*s.^3+a4*s.^4+a5*s.^5+a6*s.^6+a7*s.^7+a8*s.^8+a9*s.^9+a10*s.^10+a11*s.^11+a12*s.^12+a13*s.^13+a14*s.^14+a15*s.^15);
s2i=(Xi*ones(size(X))'-ones(size(Xi))*X').^2+(Yi*ones(size(Y))'-ones(size(Yi))*Y').^2;
si=sqrt(s2i);
Csz=(a0+a1*si+a2*si.^2+a3*si.^3+a4*si.^4+a5*si.^5+a6*si.^6+a7*si.^7+a8*si.^8+a9*si.^9+a10*si.^10+a11*si.^11+a12*si.^12+a13*si.^13+a14*si.^14+a15*si.^15);
LF=(Czz+diag(N))\eye(size(Czz));
SolG=Csz*(LF*G);
end
end